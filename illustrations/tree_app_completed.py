...
mptt_skill = Skill("MPTT", KnowledgeState.KNOWN_AWARE)
d3_skill = Skill("D3.js\nlibrary", KnowledgeState.KNOWN_AWARE)
...
web_project_actual = KnowledgeHierachy("TreeVis completion of project", nodes=web_dev_2_nodes)
#backend
